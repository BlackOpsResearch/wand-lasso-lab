...
import { Film, Scissors, Play, Camera, Sparkles, ChevronLeft, ChevronRight } from 'lucide-react';

const tools = [
  { id: 'timeline', icon: Film, label: 'Timeline', shortcut: 'T' },
  { id: 'trim', icon: Scissors, label: 'Trim/Cut', shortcut: 'C' },
  { id: 'playback', icon: Play, label: 'Playback', shortcut: 'Space' },
  { id: 'camera', icon: Camera, label: 'Camera Tools', shortcut: 'K' },
  { id: 'effects', icon: Sparkles, label: 'Video Effects', shortcut: 'E' },
];
...
export const VideoLeftToolbar: React.FC<VideoLeftToolbarProps> = ({ 
  onToggleSettings, 
  settingsCollapsed 
}) => {
  return (
